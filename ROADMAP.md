...
| 096C | EM ANDAMENTO | `low` |

`096A`, `096B` e `096C` foram inseridas sem renumerar o lote mobile aprovado. A PR096B entregou MFA TOTP, recuperação e provisionamento seguro do primeiro Administrador de staging. A PR096C corrige o reconhecimento do desafio MFA pelo console web e aguarda aceite em staging; PR097–PR107 permanecem pausadas até novo direcionamento.
