export interface PainelAdministracaoOperacional {
  ...
  readonly integracoes: readonly { readonly codigo: 'CANAL_WHATSAPP' | 'POSTGRESQL' | 'SESSAO_ACESSO' | 'SISTEMA_GESTAO'; readonly estado: 'ATIVA' | 'NAO_CONFIGURADA' | 'PARCIAL'; readonly detalhe: string }[];
}
