...
/**
 * Registra nota privada sem envio ao canal externo
 */
export const adicionarNotaInternaMobile = <ThrowOnError extends boolean = false>(options: Options<AdicionarNotaInternaMobileData, ThrowOnError>): RequestResult<AdicionarNotaInternaMobileResponses, unknown, ThrowOnError> => (options.client ?? client).post<AdicionarNotaInternaMobileResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Resgata explicitamente com versão e idempotência
 */
export const resgatarAtendimentoMobile = <ThrowOnError extends boolean = false>(options: Options<ResgatarAtendimentoMobileData, ThrowOnError>): RequestResult<ResgatarAtendimentoMobileResponses, unknown, ThrowOnError> => (options.client ?? client).post<ResgatarAtendimentoMobileResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Registra nota privada sem envio ao canal externo
 */
export const adicionarNotaInternaWeb = <ThrowOnError extends boolean = false>(options: Options<AdicionarNotaInternaWebData, ThrowOnError>): RequestResult<AdicionarNotaInternaWebResponses, unknown, ThrowOnError> => (options.client ?? client).post<AdicionarNotaInternaWebResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: '__Host-vyntra_sessao',
            type: 'apiKey'
 ...
 * Consulta atribuição e capacidades operacionais atuais
 */
export const consultarOperacaoAtendimentoWeb = <ThrowOnError extends boolean = false>(options: Options<ConsultarOperacaoAtendimentoWebData, ThrowOnError>): RequestResult<ConsultarOperacaoAtendimentoWebResponses, unknown, ThrowOnError> => (options.client ?? client).get<ConsultarOperacaoAtendimentoWebResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: '__Host-vyntra_sessao',
            type: 'apiKey'
 ...
 * Resgata explicitamente com versão e idempotência
 */
export const resgatarAtendimentoWeb = <ThrowOnError extends boolean = false>(options: Options<ResgatarAtendimentoWebData, ThrowOnError>): RequestResult<ResgatarAtendimentoWebResponses, unknown, ThrowOnError> => (options.client ?? client).post<ResgatarAtendimentoWebResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: '__Host-vyntra_sessao',
            type: 'apiKey'
...
/**
 * Expõe métricas e alertas agregados sem dados protegidos
 */
export const observarOperacao = <ThrowOnError extends boolean = false>(options?: Options<ObservarOperacaoData, ThrowOnError>): RequestResult<ObservarOperacaoResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ObservarOperacaoResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: '__Host-vyntra_sessao',
            type: 'apiKey'
